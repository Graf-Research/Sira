...
var grammar = {
    ...
    {"name": "table_type", "symbols": [(lexer.has("keywords_type_datetime") ? {type: "keywords_type_datetime"} : keywords_type_datetime)], "postprocess": id},
    {"name": "table_type", "symbols": [(lexer.has("keywords_type_date") ? {type: "keywords_type_date"} : keywords_type_date)], "postprocess": id},
    {"name": "table_type", "symbols": [(lexer.has("keywords_type_time") ? {type: "keywords_type_time"} : keywords_type_time)], "postprocess": id},
